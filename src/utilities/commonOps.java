...
public class commonOps extends utils {
	...
	// This Function Verify if Element Exists on Page (Verification made By DOM
	// Recognition)
	...
	public static void verifyElementExists(WebElement element)
		...
		try {
			...
			test.log(LogStatus.FAIL, "DOM Verification Failed, Element NOT Exists, Error Message: " + exp.getMessage()
	...
	// enter text to question and answer
	...
	// This Function Verify if Element Displayed on Page (Verification made By DOM
	// Recognition)
	// <param name="element">DOM Element</param>
	public static void verifyElementDisplay(WebElement element)
		...
		try {
			if (element.isDisplayed())
				...
				test.log(LogStatus.FAIL, "DOM Verification Failed, Element Not Displayed: " + element
						+ test.addScreenCapture(extentReportManager.CaptureScreen(timeStamp)));
	...
	// This Function Verify if Element is Not Displayed on Page (Verification made
	// By DOM Recognition)
	// <param name="element">DOM Element</param>
	public void verifyElementNotDisplay(WebElement element)
			throws ParserConfigurationException, SAXException, IOException {
		try {
			if (!element.isDisplayed())
				test.log(LogStatus.PASS, "DOM Verification Passed, Element Not Displayed: " + element);
			else {
				test.log(LogStatus.FAIL, "DOM Verification Failed, Element Displayed: " + element
						+ test.addScreenCapture(extentReportManager.CaptureScreen(timeStamp)));
